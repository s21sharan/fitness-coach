...
export function buildSystemPrompt(input: SystemPromptInput): string {
  ...
  lines.push("- regenerate_plan: full multi-week rewrite. Only use when the user asks to restructure their whole plan or change their split.");
  lines.push("- After regenerating, present the new weekly layout clearly so the user can review before accepting.");
  lines.push("");
