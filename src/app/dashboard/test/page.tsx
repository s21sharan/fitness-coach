...
export default function TestPage() {
  ...
  const triggerSync = async (provider: string) => {
    ...
    // Wait a few seconds for sync to process, then refresh
    setTimeout(() => {
      fetchData();
      setSyncing(null);
    }, 3000);
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-gray-500">Connect platforms and view synced data from the last 30 days.</p>
      </div>
